        ...
        item:
            ...
            list
                .map((index, item) => {
                    ...
                    if (username === "wsj_rss" || username === "theinitium_rss") {
                    ...
                    if (username === "theinitium_rss") {
                        ...
                        messageTitle = messageTitle.replace(/\s*\|\s*Telegraph\s*\|\s*原文\s*$/, ""); // 去掉后缀
                    }
                    ...
                    if (username === "niuyueshibao_rss") {
                        ...
                        messageTitle = messageTitle.replace(/\s*\|\s*Telegraph\s*\|\s*原文\s*\|\s*加入书友群\s*$/, "");
                    }
