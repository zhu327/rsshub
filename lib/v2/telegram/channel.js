        ...
        item:
            ...
            list
                .map((index, item) => {
                    ...
                    if (username === "niuyueshibao_rss" || username === "wsj_rss" || username === "theinitium_rss") {
                    ...
                    if (username === "theinitium_rss") {
                        messageTitle = messageTitle.replace(/^.*?- 最新\s*/, ""); // 去掉前缀
                        const suffix = "Telegraph | 原文";
